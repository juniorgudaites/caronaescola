package br.com.gudaites.caronaescola.codecs;


import br.com.gudaites.caronaescola.models.*;
import org.bson.*;
...
/**
 * Class para criar o Codec de Aluno para o MongoDB
...
public class AlunoCodec implements CollectibleCodec<Aluno> {
    ...
    public void encode(BsonWriter writer, Aluno aluno, EncoderContext encoder) {
        ...
        document.put("_id", id);    // encode id
        document.put("nome", nome); // encode nome
        document.put("data_nascimento", dataNascimento);    //encode data_nascimento
        document.put("curso", new Document("nome", curso.getNome())); // encode curso
//      encode habilidades
        if (habilidades != null) {
...
//      encode contato
    ...
    public Aluno decode(BsonReader reader, DecoderContext decoder) {
        ...
        aluno.setId(document.getObjectId("_id"));   // decode id
        aluno.setNome(document.getString("nome"));  // decone nome
        aluno.setDataNascimento(document.getDate("data_nascimento"));   // decode data_nascimento
//      decode curso
